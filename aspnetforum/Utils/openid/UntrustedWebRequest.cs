...
namespace aspnetforum.Utils.openid {
	...
	using aspnetforum.Utils.openid.Configuration;
	/// <summary>
	...
	public static class UntrustedWebRequest {
        ...
        private static string UserAgentValue = "Mozilla/4.0 (AspNetForum OpenId crawler)";
		...
		static bool isUriAllowable(Uri uri) {
			...
			openid.Util.Func<string, bool> failsUnlessWhitelisted = (string reason) => {
